...
const TR = {
 ...
 cancel: { fr: "Annuler", en: "Cancel", ar: "إلغاء" },
  ...
  splitsHint: { fr: "Astuce : utilisez la caméra ou l'analyse vidéo IA pour extraire les temps depuis une vidéo de course.", en: "Use the camera or AI video analysis to extract times from a run video.", ar: "نصيحة: استخدم الكاميرا أو تحليل الفيديو بالذكاء الاصطناعي لاستخراج الأزمنة من الفيديو." },
