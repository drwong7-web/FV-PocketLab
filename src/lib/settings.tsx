...
const TR = {
 ...
 cancel: { fr: "Annuler", en: "Cancel", ar: "إلغاء" },
  ...
  // ---- Jump test ----
  jumpTestTitle: { fr: "SAUT VERTICAL", en: "Vertical jump test", ar: "اختبار القفز العمودي" },
  jumpTestSubtitle: { fr: "Profil F-V à partir de squat jumps charges.", en: "Samozino F-V profile from loaded squat jumps.", ar: "ملف F-V لسامودزينو من قفزات القرفصاء المحمّلة." },
