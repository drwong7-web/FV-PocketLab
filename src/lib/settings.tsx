...
const TR = {
 ...
 cancel: { fr: "Annuler", en: "Cancel", ar: "إلغاء" },
  ...
  // ---- Jump test ----
  jumpTestTitle: { fr: "Test de saut vertical", en: "Vertical jump test", ar: "اختبار القفز العمودي" },
  jumpTestSubtitle: { fr: "Profil F-V Samozino à partir de squat jumps chargés.", en: "Samozino F-V profile from loaded squat jumps.", ar: "ملف F-V لسامودزينو من قفزات القرفصاء المحمّلة." },
  ...
  loadKg: { fr: "Charge (kg)", en: "Load (kg)", ar: "الحمولة (كغ)" },
  jumpHeightCm: { fr: "Hauteur de saut (cm)", en: "Jump height (cm)", ar: "ارتفاع القفز (سم)" },
  ...
  // ---- Sprint test ----
  sprintTestTitle: { fr: "Test sprint", en: "Sprint test", ar: "اختبار العدو" },
  sprintTestSubtitle: { fr: "Profil F-V horizontal — Morin & Samozino.", en: "Horizontal F-V profile — Morin & Samozino.", ar: "ملف F-V الأفقي — مورين وسامودزينو." },
  ...
  step2Protocol: { fr: "2. Protocole", en: "2. Protocol", ar: "2. البروتوكول" },
  step3Conditions: { fr: "3. Conditions", en: "3. Conditions", ar: "3. الظروف" },
  step4Splits: { fr: "4. Splits", en: "4. Splits", ar: "4. الأزمنة الجزئية" },
  step5Notes: { fr: "5. Notes", en: "5. Notes", ar: "5. ملاحظات" },
