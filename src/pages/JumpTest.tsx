  ...
  return (
    <div className="space-y-5">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)_2.5rem_2.5rem_2.5rem] gap-1 text-xs font-medium text-muted-foreground">
          ...
          {trials.map((tr, i) => (
            <div key={i} className="mt-2 grid grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)_2.5rem_2.5rem_2.5rem] gap-1 items-center">
